...
// 		elems[i].classList.toggle('nasta3');
// 	});
// }
...
// for (let button of buttons) {
// 	button.addEventListener('click', function() {
// 		button.previousElementSibling.classList.toggle('nasta3');
// 	});
// }
